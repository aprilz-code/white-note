...
![01_为什么MySQL要读写分离？](https://cdn.losey.top/blog/01_为什么MySQL要读写分离？.png)
...
![02_MySQL主从复制原理](https://cdn.losey.top/blog/02_MySQL主从复制原理.png)
...
- 如果确实是存在必须先插入，立马要求就查询到，然后立马就要反过来执行一些操作，对这个查询设置直连主库。不推荐这种方法，你这么搞导致读写分离的意义就丧失了
 ...
 ![03_MySQL主从延迟导致的生产环境的问题](https://cdn.losey.top/blog/03_MySQL主从延迟导致的生产环境的问题.png)