...
![image-20200420070841754](https://cdn.losey.top/blog/image-20200420070841754.png)
...
![image-20200420091806944](https://cdn.losey.top/blog/image-20200420091806944.png)
...
首先是比如RabbitMQ、RocketMQ、Kafka都会出现消息重复消费的问题，因为这个问题通常不是MQ自己保证的，而是保证消息的不丢失，我们首先从Kafka上来说：
