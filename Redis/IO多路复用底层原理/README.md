...
![image-20200701203511839](https://cdn.losey.top/blog/image-20200701203511839.png)
...
![image-20200701205141858](https://cdn.losey.top/blog/image-20200701205141858.png)
...
![image-20200701205539126](https://cdn.losey.top/blog/image-20200701205539126.png)

还有一个目录，就是 fd目录，在该目录下，就是我们的一些IO流

![image-20200701205750115](https://cdn.losey.top/blog/image-20200701205750115.png)

上面的0,1,2，分别对应着 输入流，输出流和错误流。在java里面我们流就是对象，而在linux系统中，流就是一个个的文件。后面的4,5 就对应着我们的socket通信，分别对应着ipv4 和 ipv6

![image-20200701205958499](https://cdn.losey.top/blog/image-20200701205958499.png)

通过netstat命令查看

![image-20200701210121933](https://cdn.losey.top/blog/image-20200701210121933.png)
...
![image-20200701210428515](https://cdn.losey.top/blog/image-20200701210428515.png)

然后在看文件里面，也多了一个socket

![image-20200701210733202](https://cdn.losey.top/blog/image-20200701210733202.png)

我们查看系统调用，发现通过系统调用接收了一个58181端口号的请求，在前面我们还能够看到5，这个5其实就是对应的上图里面的socket，走的是ipv4。

![image-20200701210907287](https://cdn.losey.top/blog/image-20200701210907287.png)
...
![image-20200701213855739](https://cdn.losey.top/blog/image-20200701213855739.png)
...
![image-20200701215310148](https://cdn.losey.top/blog/image-20200701215310148.png)
...
![image-20200701215254768](https://cdn.losey.top/blog/image-20200701215254768.png)
...
![image-20200702081602327](https://cdn.losey.top/blog/image-20200702081602327.png)
...
![image-20200702083635139](https://cdn.losey.top/blog/image-20200702083635139.png)
...
![image-20200702084219155](https://cdn.losey.top/blog/image-20200702084219155.png)
...
![image-20200702090307355](https://cdn.losey.top/blog/image-20200702090307355.png)
