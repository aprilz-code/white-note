### <center>使用ELK搭建博客日志收集
***
## 前言

前阵子学习了ElasticStack的技术栈，其中包括ElasticSearch 、Beats、Kibana、Logstash。因为打算将其用于博客的项目中，关于ElasticStack的技术栈学习，可以参考前面写的博客~
...
通过本教程，可以非常方便的给博客项目，集成ELK用于分布式日志收集
...
> 需要注意，Beats不在我们ELK服务器上进行启动了，我们需要到部署博客的服务器上，然后找到Beats目录
