...
![image-20201111185527326](https://cdn.losey.top/blog/image-20201111185527326.png)

在我们安装好 VMware Workstations后，我们可以打开网络中心会发现生成 两个虚拟网卡，我们打开网络和共享中心能够看到下面的两个

![image-20201111185846985](https://cdn.losey.top/blog/image-20201111185846985.png)

关于这两个网卡对应的规则，我们可以到VMware的虚拟网络编辑器查看

![image-20201111190045658](https://cdn.losey.top/blog/image-20201111190045658.png)
...
![img](https://cdn.losey.top/blog/161210210454533.png)
...
![img](https://cdn.losey.top/blog/161210210454532.png)
...
![img](https://cdn.losey.top/blog/1556289446518.png)
...
![image-20201111194922373](https://cdn.losey.top/blog/image-20201111194922373.png)
...
![image-20201111195255554](https://cdn.losey.top/blog/image-20201111195255554.png)

在还原后，我们在上面能够看到有三种模式了，这里我们主要是 操作 NAT模式

![image-20201111195414104](https://cdn.losey.top/blog/image-20201111195414104.png)

- 首先选择NAT模式
- 然后勾选2中的两个选项
- 第三步就是打开NAT设置

![image-20201111195510211](https://cdn.losey.top/blog/image-20201111195510211.png)

然后设置网关IP为： 192.168.13.254  【这里需要记住这个值，以后会用到】，然后保存

- 第四步点击 DHCP设置

![image-20201111195622025](https://cdn.losey.top/blog/image-20201111195622025.png)
...
![image-20201111195945529](https://cdn.losey.top/blog/image-20201111195945529.png)

然后找到网络适配器，选择NAT模式，这样我们的系统就通过NAT模式连接了

![image-20201111200047649](https://cdn.losey.top/blog/image-20201111200047649.png)
...
![image-20201111220338773](https://cdn.losey.top/blog/image-20201111220338773.png)
...
![image-20201113145306958](https://cdn.losey.top/blog/image-20201113145306958.png)

重启后打开虚拟机，发现能够成功联网了~

![image-20201113145500500](https://cdn.losey.top/blog/image-20201113145500500.png)
