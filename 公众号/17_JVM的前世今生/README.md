...
![](https://cdn.losey.top/blog/image-20200704111417472.png)
...
![高级语言](https://cdn.losey.top/blog/image-20200704112119729.png)
...
![Java VS C++](https://cdn.losey.top/blog/image-20200704112700211.png)

**C语言**需要自己来分配内存和回收内存，**Java** 全部交给 **JVM** 进行分配和回收。

## 推荐书籍

![JVM书籍](https://cdn.losey.top/blog/image-20200704145340513.png)
...
![一次编写，到处运行](https://cdn.losey.top/blog/image-20200704151731216.png)

每个语言都需要转换成字节码文件，最后转换的字节码文件都能通过 **Java** 虚拟机进行运行和处理

![各种平台语言](https://cdn.losey.top/blog/image-20200704152052489.png)
...
![OpenJDK和OracleJDK](https://cdn.losey.top/blog/image-20200704182035810.png)
...
![JVM所在位置](https://cdn.losey.top/blog/image-20200704183048061.png)

**Java** 的体系结构如下所示

![Java体系结构](https://cdn.losey.top/blog/image-20200704183236169.png)
...
![JVM整体结构](https://cdn.losey.top/blog/image-20200704183436495.png)
